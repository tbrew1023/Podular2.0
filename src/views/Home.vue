...
export default {
  ...
  mounted() {
    ...
    setInterval(() => {
      ...
      document.getElementById("big-image").style.backgroundImage =
        "url(" + require("@/" + aboutPath) + ")";
  ...
  methods: {
    ...
    enterOn(section, context) {
      if (context == "default") {
        ...
        return this.activeSection == section - 1
          ? "delay-enter"
          : "delay-stage";
...
<template>
  <div class="home">
    <div
      :class="modalActive ? 'modal-active' : 'modal-inactive'"
    ...
    >
      ...
      <div class="modal">
        <iframe
          class="iframe"
          v-if="modalContext == 'showroom'"
          src="https://wix.viar.live/embed/tour/tdodwm"
          width="400px"
          height="400px"
        ></iframe>
        <img
          v-if="modalContext == 'gallery'"
    ...
    <div class="soc-container">
      <a
        href="https://www.facebook.com/Caf%C3%A9Bellas-LLC-1664700527089434/"
        target="_blank"
        ><div class="hoverable soc-button fb"></div
      ></a>
      <a href="https://www.instagram.com/cafebellas/" target="_blank"
        ><div class="hoverable soc-button insta"></div
      ></a>
      <a href="https://twitter.com/cafebellas" target="_blank"
        ><div class="hoverable soc-button tw"></div
      ></a>
      <a
        href="https://www.linkedin.com/company/cafebellas-of-illinois/"
        target="_blank"
        ><div class="hoverable soc-button li"></div
      ></a>
    </div>
    ...
    <full-page ref="fullpage" :options="options" id="fullpage">
        ...
        <div class="landing-container">
          <div class="video-container">
            <video loop muted data-keepplaying id="landing-video">
              <source
                src="../assets/videos/landing-compressed.mp4"
                type="video/mp4"
              />
      ...
      <section style="background: black" class="section">
        <div class="slide">
          <div class="page-container">
            <div class="about-container">
              <div class="about-text">
                <div class="about-text-inner">
                  ...
                  <div class="button-container">
                    <div
                      @click="move(3)"
                      class="arrows hoverable"
                      :class="enterOn(2, 'arrows')"
                    ></div>
                    <div class="slide-button hoverable" @click="moveRight()">
                      <div class="arrows arrows2 hoverable"></div>
                    </div>
                  </div>
                </div>
              </div>
              <div
                id="big-image"
                class="image-slides full-image"
                :class="enterOn(2, 'big-image')"
              >
                <div class="wave-container">
                  <div class="lil-wave" :class="enterOn(2, 'wave')"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style="background: black" class="slide">
          <div class="page-container">
            ...
            <div class="slide-button back hoverable" @click="moveLeft()">
              <div class="arrows arrows2 hoverable"></div>
            </div>
            ...
            <div class="grid">
              <!-- animates first 11 items rendered -->
              <div
          ...
          <div class="page-container">
            <div class="about-container">
              ...
              <div
                id="big-image2"
                class="image-slides full-image"
                :class="enterOn(3, 'big-image2')"
              >
                <div class="wave-container">
                  <div class="lil-wave" :class="enterOn(3, 'wave')"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style="background: black" class="slide">
          <div class="page-container">
            <div class="clickable-container">
              <div
                v-if="dotAppear"
                class="dot hoverable dot1"
                @mouseover="hovering(0)"
                @mouseleave="
                  hoveringV[0] = false;
                  $forceUpdate();
                "
              >
                <div v-if="hoveringV[0]" class="hover-box">
                  <h3>Outer shell</h3>
                  <p>
                    Can come in multiple finishes, including white, black, or
                    gun-metal grey, and any RGB color in a glossy or matte coat.
                  </p>
                </div>
              </div>
              <div
                v-if="dotAppear"
                class="dot hoverable dot2"
              ...
              >
                <div v-if="hoveringV[1]" class="hover-box">
                  ...
                  <p>
                    Built-in multi-color and remote controlable LEDs bright
                    enough to light up your Podular Unit at night and make your
                    services shine even in the day!
                  </p>
                </div>
              </div>
              <div
                v-if="dotAppear"
                class="dot hoverable dot3"
              ...
              >
                <div v-if="hoveringV[2]" class="hover-box">
                  ...
                  <p>
                    Specially designed and engineered to handle all of your
                    service loads and provide a sturdy, stable working
                    enviroment!
                  </p>
                </div>
              </div>
              ...
              >
                <div v-if="hoveringV[3]" class="hover-box">
                  ...
                  <p>
                    Simple and customizable shelving that can be coated in a
                    number of material finishes to accomodate your needs!
                  </p>
                </div>
              </div>
            </div>
      ...
      <section class="section">
        <div style="background: black" class="slide">
          <div class="page-container">
            <div
              class="passcode-input-container"
              :class="enterOn(5, 'default')"
            >
